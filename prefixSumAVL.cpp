...
// We'll call Delete recursively
    ...
    Level_Order_Traversal(root);
    cout << endl;
    cout << "Input the element of which you want to find the prefix_sum of: ";
    cin >> X;
    //Update_Count_Using_Post_Order_Traversal(root);
    //cout << "Count of all -> ";
    //Inorder_Traversal(root);
    //cout << endl;
    int prefix_sum = Prefix_Sum(root, X);
    cout << "The prefix_sum of input element is: " << prefix_sum << endl;
    cout << "The key of the node that is to be deleted -> ";
    cin >> X;
    root = Delete(root, X);
    cout << "The Inorder Traversal -> ";
